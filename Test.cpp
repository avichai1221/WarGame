...
TEST_CASE("place the players on board and check errors"){
    ...
    board[{0,0}] = new WarGame::FootSoldier(1);
    board[{0,1}] = new WarGame::FootCommander(1);
    board[{0,2}] = new WarGame::ParamedicCommander(1);
    board[{0,3}] = new WarGame::Sniper(1);

    board[{3,0}] = new WarGame::Paramedic(2);
    board[{3,1}] = new WarGame::FootCommander(2);
    board[{3,2}] = new WarGame::SniperCommander(2);
    board[{3,3}] = new WarGame::FootSoldier(2);
   ...
   // board.print();
    ...
    board[{0,0}] = new WarGame::FootSoldier(1);
    board[{0,2}] = new WarGame::FootCommander(1);
    board[{1,3}] = new WarGame::FootSoldier(1);
    board[{1,1}] = new WarGame::FootSoldier(2);
    board[{3,0}] = new WarGame::FootSoldier(2);
    board[{0,4}] = new WarGame::Paramedic(1);
    board[{1,4}] = new WarGame::SniperCommander(1);
...
TEST_CASE(" check Sniper and SniperCommander attack") {
    ...
    board[{0, 2}] = new WarGame::SniperCommander(1);
    board[{1, 3}] = new WarGame::Sniper(1);
    board[{0, 4}] = new WarGame::Paramedic(1);
    board[{1, 4}] = new WarGame::FootSoldier(1);
    board[{1, 1}] = new WarGame::Sniper(2);
    board[{3, 0}] = new WarGame::Sniper(2);
    board[{4, 0}] = new WarGame::Paramedic(2);
...
TEST_CASE(" check Paramedic and ParamedicCommander attack") {
    ...
    board[{0, 0}] = new WarGame::SniperCommander(1);
    board[{0, 1}] = new WarGame::Sniper(1);
    board[{1, 4}] = new WarGame::Sniper(2);
    board[{3, 3}] = new WarGame::Paramedic(2);
    board[{3, 4}] = new WarGame::Paramedic(2);
    board[{4, 2}] = new WarGame::FootSoldier(2);
    ...
    board[{0, 2}] = new WarGame::Sniper(1);
    board[{2, 2}] = new WarGame::Sniper(1);
    board.move(1, {0,2}, WarGame::Board::MoveDIR::Right);
   ...
   //
    ...
    board[{1, 4}] = new WarGame::Paramedic(2);
